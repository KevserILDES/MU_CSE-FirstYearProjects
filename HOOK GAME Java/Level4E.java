...
//This class is for the forth level of the game
public class Level4E extends Application{
		...
		disconnector.setOnMouseClicked(e -> {
			if(disappPause){
				if(inDisc.getEndY()==vLLineB2.getStartY()){ 
					inDisc.setStartY(hLLineA1.getEndY()); 
					inDisc.setStartX(hLLineA1.getEndX()); 
					inDisc.setEndY(hLLineA2.getStartY());
					inDisc.setEndX(hLLineA2.getStartX()); 
				} 
				else {
					inDisc.setEndY(vLLineB2.getStartY());
					inDisc.setEndX(vLLineB2.getStartX());
					inDisc.setStartY(vLLineB1.getEndY());
					inDisc.setStartX(vLLineB1.getEndX()); 
				}
			}});
