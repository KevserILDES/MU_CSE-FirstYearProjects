...
//This class is for the fist level of the game
public class Level1E extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Line hBLineA=new Line(440,300,460,300);//creating horizontal bold line 
		hBLineA.setStroke(Color.BLACK);
		hBLineA.setStrokeWidth(3);
		Line vBLineA=new Line(450,300,450,80);//creating vertical bold line 
